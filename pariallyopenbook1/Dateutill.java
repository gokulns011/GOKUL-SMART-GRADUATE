...
public class Dateutill {
	...
	public static String[] daysInWeek = {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"};
	...
	System.out.println(isvaldate(2012, 2, 29));
	System.out.println(isvaldate(2011, 2, 29));
	System.out.println(isvaldate(2099, 12, 31));
	System.out.println(isvaldate(2099, 12, 32));
	System.out.println();
	...
	public static boolean isvaldate(int year, int month, int date) {
	if (year < 1 || year > 9999) 
	{
	return false;
	} 
	...
	dayOfWeek = (centnum + yearNumber + (yearNumber / 4) + monthTableValue + date) % 7;
	return dayOfWeek;
	}
